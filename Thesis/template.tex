...
%% Header section
\title{Sample Thesis/Dissertation Title} %%required
\author{Johnrob Y. Bantang} %% required
\email{johnrob.bantang@gmail.com}%% appears only when draft version use \draft option.
\adviser{My O. Adviser}{Ph.D.}%% required
...
\director{Caesar A. Saloma}{Ph.D.}%% required
\dean{Rhodora V. Azanza}{Ph.D.} %%required
\gradyear{2006} \gradmonth{April} %%graduation month and year
\defenseDate{xx March 2006}
...
\input{2litReview.tex}
\input{3myChapter.tex} %%could be model or experiment set-up
\input{4anotherChapter.tex} %%could be results and discussions
